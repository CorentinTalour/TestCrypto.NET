...
namespace TestCrytpoServer.Migrations
{
    ...
    [Migration("20251029123522_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestCrytpoServer.EF.SecretRecord", b =>
                {
                    ...
                    b.Property<string>("TagNameB64")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TagNotesB64")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TagPasswordB64")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TagUrlB64")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TestCrytpoServer.EF.SecretRecord", b =>
                {
                    b.HasOne("TestCrytpoServer.EF.Vault", "Vault")
                        .WithMany("Secrets")
